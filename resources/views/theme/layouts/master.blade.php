...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-body position-relative app-blank">
    ...
    <script src="{{ asset('theme/assets/plugins/custom/typedjs/typedjs.bundle.js') }}"></script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('theme/assets/js/custom/landing.js') }}"></script>
    <script src="{{ asset('theme/assets/js/custom/pages/pricing/general.js') }}"></script>
