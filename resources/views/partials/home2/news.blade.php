    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="card" style='background-image: url("{{ asset('') }}assets2/img/more-services-1.jpg");'
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                <div class="card" style='background-image: url("{{ asset('') }}assets2/img/more-services-2.jpg");'
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4">
                <div class="card" style='background-image: url("{{ asset('') }}assets2/img/more-services-3.jpg");'
                    data-aos="fade-up" data-aos-delay="100">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4">
                <div class="card" style='background-image: url("{{ asset('') }}assets2/img/more-services-4.jpg");'
                    data-aos="fade-up" data-aos-delay="200">
                    <div class="card-body">
